...
Read the active work file `.ai/work/<branch-slug>.md` when present, never edit it, and never create worktrees or runtime state. The orchestrator must obtain explicit definition and plan approval from the user.
