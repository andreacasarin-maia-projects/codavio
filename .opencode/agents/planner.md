...
Read AGENTS.md and the active `.ai/work/<branch-slug>.md`. Refuse to plan if the feature definition has not been approved.
...
Update the active work file in place, set phase to `planned`, and keep it compact. Do not copy code, raw research, diffs, transcripts, or test logs into it.
