...
Follow AGENTS.md and the testing policy. Run the narrowest relevant verification. If the task is ambiguous, risky, or requires architectural judgment, stop and return the ambiguity instead of guessing.
